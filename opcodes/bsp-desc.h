...
typedef enum ifield_type {
 ...
 , BSP_F_IGNORE_C, BSP_F_RD_CD, BSP_F_RALT_C, BSP_F_EXT_C
 , BSP_F_RS_C, BSP_F_Q_D, BSP_F_P_D, BSP_F_L_D
 , BSP_F_M_D, BSP_F_M2_D, BSP_F_N_D, BSP_F_MAX
} IFIELD_TYPE;
...
typedef enum cgen_operand_type {
 ...
 , BSP_OPERAND_RDCD, BSP_OPERAND_RALTC, BSP_OPERAND_RSC, BSP_OPERAND_RPAGE
 , BSP_OPERAND_RSTATUS, BSP_OPERAND_BITSWALLOW, BSP_OPERAND_Q, BSP_OPERAND_P
 , BSP_OPERAND_N, BSP_OPERAND_L, BSP_OPERAND_MAX
} CGEN_OPERAND_TYPE;
